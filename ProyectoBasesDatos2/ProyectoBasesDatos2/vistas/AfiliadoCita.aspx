<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AfiliadoCita.aspx.cs" Inherits="ProyectoBasesDatos2.vistas.AfiliadoCita" %>
                ...
                <div class="row">
                    <div class="col-sm-3 col-md-2 sidebar">
                        <ul class="nav nav-sidebar">
                            <li class="active"><a href="AfiliadoCita.aspx">Ver Citas</a></li>
                            <li><a href="AfiliadoRegistrarCita.aspx">Solicitar Cita</a></li>
                        </ul>
                        <%--                        <ul class="nav nav-sidebar">
