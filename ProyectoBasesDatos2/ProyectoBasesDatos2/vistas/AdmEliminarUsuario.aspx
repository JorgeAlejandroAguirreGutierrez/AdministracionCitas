<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AdmEliminarUsuario.aspx.cs" Inherits="ProyectoBasesDatos2.vistas.EliminarUsuario" %>
                ...
                <div class="row">
                    <div class="col-sm-3 col-md-2 sidebar">
                        <ul class="nav nav-sidebar">
                            ...
                            <li class="active"><a href="AdmEliminarUsuario.aspx">Eliminar Usuario</a></li>
                        </ul>
<%--                        <ul class="nav nav-sidebar">
                    ...
                    <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
                        ...
                        <h2 class="sub-header">Usuario a Eliminar</h2>
                        <div class="col-xs-12">
                            <h4>Cedula</h4>
                            <br />
                            ...
                            <br />
                            <br />
                            <asp:Button ID="Button2" runat="server" Text="Eliminar" CssClass="btn btn-lg btn-warning" OnClick="Button2_Click" />
                            <br />
