<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AdmRegistrarMulta.aspx.cs" Inherits="ProyectoBasesDatos2.vistas.AdmRegistrarMulta" %>
...
<head runat="server">
    ...
    <title>EPS SERVICO Multas</title>
...
<%--                        <ul class="nav nav-sidebar">
                    ...
                    <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
                        <h1 class="page-header">REGISTRAR MULTA</h1>
